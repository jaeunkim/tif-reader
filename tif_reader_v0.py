...
class TifReader(QtWidgets.QMainWindow, Ui_Form):
    ...
    def __init__(self, window_title="", parent=None):
        ...
        self.crop_etc_cbox.clicked.connect(self.show_popup)
    ...
    def create_menu_bar(self):
        ...
        self.view_menu.triggered.connect(self.show_popup)
    
    def show_popup(self):
        popup = popup_window(window_title="plotting options")
        popup.exec()
    ...
    def cancel_loading(self):
        self.log_label.setText("Cancelling...")
        self.loader_thread.running_flag = False
...
class popup_window(QDialog):
    def __init__(self, window_title="", parent=None):
        ...
        popup_ui_file = dirname + '/popup_v0.ui'
        self.popup_ui_form = uic.loadUiType(popup_ui_file)[0]
        self.popup_ui_form.setupUi(self)
        # self.setupUi(self)
        self.setWindowTitle(window_title)
